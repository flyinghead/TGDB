...
class TGDB
{
	...
	{
		$qry = "SELECT UE.id, UE.timestamp, UE.type, UE.value, UE.users_id, US.username FROM user_edits UE, users US WHERE UE.games_id = :games_id and US.id = UE.users_id order by UE.id DESC;";
